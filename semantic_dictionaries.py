...
def stop_words_en_set1():
    sw = ["'ve", "'ll", 'lot', "n't", "'d", "'m","'re","2", "3", "1", "4", "5","6","7","8","9"]
    return sw
'''
Sentiment analysis
'''
...
#          'demais','d+']
    pw = ['lindo', 'gostei', 'adorei', 'adoro', 'otimo','otima', 'favorito', 'amei', 
          ...
          'demais','d+','saudade','dahora', 'carinho', 'especial', 
          'desconto', 'gratis', 'gratuitamente', 'maneiro', 'graca','gracinha',
          'gracioso','graciosa','falha', 'diverte','divertido','divertida','reina','facil']               
    return pw
...
def negative_words():
    ...
    nw = ['ruim','pessimo', 'horrivel', 'calamidade','lixo','vergonha',
          ...
          'imbecil', 'enojado','absurdo','absurdos','abuso','abusada','abusado',
          'dificil','nada']
    return nw
...
def negative_facts_words():
    nfw = ['invadir', 'invasão', 'explodir', 'explosão', 'protesto', 'depredar',
          ...
          'sequestrado', 'roubo','roubado','roubada','furto','furtada','furtado',
          'corruptos','corrupcao', 'acidente', 'tráfico',
          'drogas', 'drogado', 'greve', 'grevistas', 'paralização', 'terrorismo',
          'terrorista', 'morto', 'morta', 'morte','mortes', 'morre','passeata','tiroteio','balear', 
          'baleado', 'prender', 'fogo', 'incendio', 'incendiar', 'ataque',  
          'atacado', 'atacar', 'covardemente', 'covarde', 'preso','hack', 
          'hacked', 'hackeado', 'deface','irregular', 'condenado', 'condenada', 'condenacao',
          'condenação','condena',   'condenadas','condenados','capotei','capotou','capotaram',
          'carbonizado','carbonizada','carbonizados','carbonizadas', 'queimado','queimados',
          'queimada','queimadas']
...
def extended_positive():   
    pwdictionary = ["abencoada","abencoadas","abencoado","abencoados","abrilhantada",
...
def extended_negative():
    
    nwdictionary = ["abandalhada","abandalhadas","abandalhado","abandalhados","abandonada",
...
def extended_neutral_words():
    neutralwdictionary = ["acreditando","acredite","acreditei","aleatoria","algum dia","alteracao","alteracoes",
